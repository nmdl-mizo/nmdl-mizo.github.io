...
##### 我々の研究目的 ＝ “ 物質の構造機能相関を解明し物質を設計する ”

<p align="left">物質開発は長らく，試行錯誤の繰り返しであり続けてきました．しかし今，その構図を根本から変える時代が来ています．
我々が目指すのは，「Designed Materialsの実現」，つまり目的の機能を実現するために原子配列を意図的に設計し，自然界には存在しない構造をも作り出す，物質開発の新たなパラダイムです．
その実現の根底にあるものは，原子・電子構造と機能を結ぶ「構造機能相関」の深い理解です．物質のどこでどのような機能を生み出すのか．そのメカニズムを化学結合レベルで解明し，そしてその理解を物質開発に実装できれば，物質は「発見するもの」から「設計するもの」へと変わります．
溝口研究室は，人工知能技術・Physical AI，計算機シミュレーション・物質計測を融合させ，構造機能相関の解明からDesigned Materialsの実現までを一気通貫で推進し，自律的に物質を設計・創出する新たな物質科学のパラダイムの確立を目指しています．


##### AI for Materials: Designed Materialsの実現に向けたデータ駆動型物質設計
 <p align="left">
近年，AI・データ科学を活用した「AI for Science」が科学研究に革新をもたらしつつあります．物質研究においても，データ科学を活用する「マテリアルズインフォマティクス」が世界的に注目を集めています．本研究室では，機械学習・大規模データ解析・生成AI・大規模言語モデル（LLM）に加え，Physical AIおよびロボティクス技術を統合的に活用し，設計・探索・合成・計測・解析を一体化したデータ駆動型物質研究基盤の構築と実装に取り組んでいます．さらに，これらを支える新規アルゴリズムの開発，実験・計算・データを横断する大規模データベースの構築，およびAIエージェントによる自律的研究プロセスの実現を推進しています．<br>
　1) 生成AIおよび大規模言語モデル（LLM）を活用した新物質設計手法の確立<br>
　2) 機械学習によるマルチモーダル物質計測<br>
　3) 逆設計による物質設計<br>
　4) AIエージェントを活用した物質探索と合成<br>
　5) データ駆動型手法を活用した新物質・新物性探索<br>
　6) Physical AIを活用した自律型物質計測手法の開発<br>
例えば，我々の手法を用いることで22年かかる計算をわずか3時間で終えることも可能です．また，人工知能技術を利用することで，これまで専門の研究者でも得ることが出来なかった新たな知見を得ることにも成功しております．
<br>
<b>キーワード：</b>マテリアルズインフォマティクス，データ駆動型，人工知能，生成ＡＩ，大規模言語モデル（LLM），AIエージェント，物質探索，スペクトル解析，自律・自動解析，Physical AI，格子欠陥，物理抽出
<br>
...
<br>
<b>キーワード：</b>半導体，強誘電体，セラミックス，二次元化合物，モアレ化合物，機械学習ポテンシャル，
<br>
...
N. Kawaguchi, K. Shibata, and T. Mizoguchi,  
ACS Physical Chemistry Au, 4 (2024), 281-291.
<br>
...
Acta Mater., 250 (2023) 118827-1-11.
<br>
...
##### エネルギー関連材料における構造機能相関の理解　　
 <p align="left">
カーボンニュートラルを実現するために高性能発電材料や蓄電材料の開発が不可欠である．本研究室では第一原理計算と機械学習，原子レベル解析により，リチウム空気電池や，太陽電池材料，イオン導電体，超伝導体などのエネルギー関連材料を対象として，界面やドーパントなどの格子欠陥近傍の原子・電子構造解析やデータ駆動型解析を利用して構造と機能との相関性を理解することをめざした研究を行っております．
<br>
<b>キーワード：</b>リチウム空気電池，燃料電池材料，太陽電池材料，イオン伝導体，超伝導体
<br>
“A Review of Simulation, Characterization, and Informatics in Inorganic Materials” [Invited Review]  
T. Mizoguchi  
J. Ceram. Soc. Jpn, 133, (2025) 713-734. 
<br>
...
N. Kawaguchi, K. Shibata, and T. Mizoguchi,  
J. Phys. Chem. C, 127 (2023) 9833-9843.
<br>
...
J. Appl. Phys., 120, 142125-1-13 (2016)
<br>
...
##### 内殻電子励起スペクトルの第一原理計算法の確立と機械学習を活用したスペクトルインフォマティックス手法の確立
...
<br>
<b>キーワード：</b>内殻電子励起分光，ELNES，XANES，一粒子，エキシトン，多電子，スペクトルデータベース，機械学習，スペクトルインフォマティックス，計測インフォマティックス
<br>
...
J. Phys. Chem. Lett., 11 (2020) 9637–9642.
<br>
...
Science Advances, 3 (2017)  e1701546-1-5.
<br>
...
Scientific Reports, 7 (2017), 16434-1-9.
<br>
